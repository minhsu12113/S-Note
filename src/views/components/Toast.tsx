...
export const Toast = ({ type, message }: ToastProp) => {
	switch (type) {
		case 'Success':
			return ToastSuccess(message);
		case 'Danger':
			return ToastDanger(message);
		case 'Warning':
			return ToastWarning(message);
		default:
			return ToastWarning('Nothing');
	}
};
...
const ToastSuccess = (message: string) => {
	return (
		<>
         ...
         bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute right-6 top-6'
				role='alert'>
...
const ToastDanger = (message: string) => {
	return (
		<>
         ...
         dark:text-gray-400 dark:bg-gray-800 absolute right-6 top-6'
				role='alert'>
